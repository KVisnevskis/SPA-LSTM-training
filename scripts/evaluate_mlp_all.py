#!/usr/bin/env python3
"""Run best-model evaluation for all MLP configs in a directory."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Evaluate all best MLP models for configs in a directory.")
    parser.add_argument(
        "--config-dir",
